...
class UserListComponent extends Component {
    ...
    refreshUsers(cp) {
        ...
        BackendService.retrieveAllUsers(cp, this.state.limit)
            .then(
                resp => {
                    this.setState({users: resp.data.content,
            ...
            <div className="m-4">
                <div className="row my-2 mr-0">
                    ...
                    <button className="btn btn-outline-secondary ml-auto"
                            onClick={this.addUserClicked}><FontAwesomeIcon icon={faPlus}/>{' '}Добавить</button>
                    <button className="btn btn-outline-secondary ml-2"
                            onClick={this.deleteUsersClicked}><FontAwesomeIcon icon={faTrash}/>{' '}Удалить</button>
                </div>
                <div className="row my-2 mr-0">
                    <PaginationComponent
