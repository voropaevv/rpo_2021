        ...
        return (
            <>
                ...
                <Nav className={'flex-column my-sidebar my-sidebar-expanded'}>
                    <Nav.Item><Nav.Link as={Link} to="/users/-1"><FontAwesomeIcon icon={faUserCircle}/>{' '}Мой аккаунт</Nav.Link></Nav.Item>
                ...
                {  !this.props.expanded &&
                    <Nav className={'flex-column  my-sidebar my-sidebar-expanded'}>
                        <Nav.Item><Nav.Link as={Link} to="/users/-1"><FontAwesomeIcon icon={faUserCircle}  size="2x"/></Nav.Link></Nav.Item>
