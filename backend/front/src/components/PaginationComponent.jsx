...
PaginationComponent.propTypes = {
    totalRecords: PropTypes.number.isRequired, // общее количество записей, подлежащих разбиению на страницы.
    pageLimit: PropTypes.number, // количество записей, отображаемых на странице
    pageNeighbours: PropTypes.number, // количество доп номеров страниц, отображаемых на каждой стороне текущей страницы
    onPageChanged: PropTypes.func // вызывается с данными текущего состояния разбиения при изменении текущей страницы.
};
