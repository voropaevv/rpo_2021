...
class Login extends React.Component {
    ...
    constructor(props) {
        ...
        // Это переменная, в которой хранится состояние компонента
        this.state = {
            username: '', // пустое имя пользователя
            password: '', // пустой пароль
            loggingIn: false, // флажок для отображения спиннера во время ожидания ответа от сервера
            submitted: false, // флажок для вывода сообщения об ошибке
            error_message: null,
        };
    ...
    // Функция handleChange делает ввод в форме контролируемым
    handleChange(e) {
